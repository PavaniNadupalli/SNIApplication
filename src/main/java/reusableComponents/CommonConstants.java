...
public class CommonConstants {
		...
		//CredentialsForLogin in all credsLogins_TestData.xlsc
		public static final String TC_NAME = "TC Name";
		 ...
		 * -- Data from a column
		 */
		public static final String TC_INSTITUTE_LOGIN_AFTER_ONBOARDING = 
				"Verify Able to Login As Institute after Onboarding Registration";
		...
		public static final String ONBOARD_INSTITUTE_FILE_UPLOAD = "PhotoUpload";
		...
		//Faculty creating data from FacultyDetailsCreatedByInstitute.xlsx - sheet name - FacultyDetails
		public static final String INSTITUTE_FACULTY_USER_NAME = "Username";
		public static final String INSTITUTE_FACULTY_SUBJECT = "ChooseSubject";
